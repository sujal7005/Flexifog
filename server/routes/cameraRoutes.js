...
// Public routes
router.get('/', getCameraProducts);
router.get('/:id', getCameraProductById);
router.get('/brand/:brand', getCameraByBrand);
router.get('/type/:type', getCameraByType);

// Protected routes (admin only) - you'll need to add auth middleware
router.post('/', uploadProductMiddleware, createCameraProduct);
router.put('/:id', uploadProductMiddleware, updateCameraProduct);
router.delete('/:id', deleteCameraProduct);
router.post('/:id/reviews', uploadReviewMiddleware, addCameraReview);
