...
import {
  getWearableProducts,
  getWearableProductById,
  createWearableProduct,
  updateWearableProduct,
  deleteWearableProduct,
  addWearableReview,
  getWearableByBrand,
  getWearableByType,
  getWearableByOS,
  getWearableByFeatures
...
// Public routes
router.get('/', getWearableProducts);
router.get('/:id', getWearableProductById);
router.get('/brand/:brand', getWearableByBrand);
router.get('/type/:type', getWearableByType);
router.get('/os/:os', getWearableByOS);
router.get('/features', getWearableByFeatures);

// Protected routes (admin only) - you'll need to add auth middleware
router.post('/', uploadProductMiddleware, createWearableProduct);
router.put('/:id', uploadProductMiddleware, updateWearableProduct);
router.delete('/:id', deleteWearableProduct);
router.post('/:id/reviews', uploadReviewMiddleware, addWearableReview);
