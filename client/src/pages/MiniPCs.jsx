...
const MiniPCs = () => {
    ...
    pcs.forEach(pc => {
      ...
      if (specs.graphiccard) {
        ...
        if (gpuStr.includes('nvidia') || gpuStr.includes('geforce') || gpuStr.includes('rtx')) {
          ...
          gpuOptions.add('AMD');
        } else if (gpuStr.includes('intel') || gpuStr.includes('iris') || gpuStr.includes('uhd')) {
          gpuOptions.add('Intel Integrated');
        }
      }
      ...
      if (description.includes('htpc') || description.includes('home theater')) features.add('Home Theater');
      ...
      if (specs.vga || description.includes('vga')) features.add('VGA Port');
      if (specs.hdmi || description.includes('hdmi')) features.add('HDMI');
      if (specs['4k'] || description.includes('4k')) features.add('4K Support');
    });
    ...
    ? pcs
      .filter((pc) => {
        ...
        if (category !== "All") {
          ...
          if (categoryLower.includes('htpc') && !name.includes('home') && !description.includes('home theater')) {
            return false;
          }
        }
        ...
        if (selectedStorage !== 'all') {
          const storage = safeToLowerCase(pc.specs?.storage || '');
        ...
        if (selectedGpu !== 'all') {
          ...
          if (selectedGpu === 'Intel Integrated' && !gpu.includes('intel') && !gpu.includes('iris') && !gpu.includes('uhd')) {
            return false;
          }
        }
        ...
        if (selectedFeatures.length > 0) {
          ...
          return selectedFeatures.every(feature => {
            switch(feature) {
              ...
              case 'Home Theater':
                return name.includes('home') || description.includes('home theater') || description.includes('htpc');
              case 'WiFi':
                return specs.wifi || description.includes('wifi');
              case 'Bluetooth':
                return specs.bluetooth || description.includes('bluetooth');
              case 'VGA Port':
                return specs.vga || description.includes('vga');
              case 'HDMI':
                return specs.hdmi || description.includes('hdmi');
              case '4K Support':
                return specs['4k'] || description.includes('4k');
              default:
                return true;
            }
          });
  ...
  const getCategoryIcon = (pc) => {
    ...
    if (name.includes('home') || description.includes('home') || description.includes('htpc')) {
      return { icon: <FaCube className="text-green-400" />, color: 'from-green-600 to-green-800' };
    }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 pt-24 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-lg font-medium mt-4">Loading Mini PCs...</p>
          <p className="text-gray-400 text-sm mt-2">Please wait while we find the perfect compact PC for you</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 pt-24 pb-20">
      <Helmet>
        ...
        <meta name="description" content="Explore high-performance mini PCs for gaming, office work, home theater, and everyday use." />
      </Helmet>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4 flex items-center">
            <FaCube className="mr-4 text-indigo-400" />
            <span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
              Mini PCs
            </span>
          </h1>
          <p className="text-lg text-gray-400">
            Discover compact yet powerful computers for every need
          </p>
          <p className="text-sm text-gray-500 mt-2">
            {filteredPCs.length} Mini PCs found
          </p>
        </motion.div>
          ...
          {compareList.length > 0 && (
            ...
            >
              <div className="flex items-center gap-4">
                <span className="font-bold">{compareList.length} Mini PC(s) selected for comparison</span>
                <button
          ...
          >
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
              <h3 className="font-bold text-white mb-4 flex items-center">
                <FaCube className="mr-2 text-indigo-400" />
                Categories
              </h3>
              <div className="space-y-2">
                <label className="flex items-center space-x-2 cursor-pointer">
                  ...
                  />
                  <span className="text-gray-300">All Mini PCs</span>
                </label>
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="radio"
                  ...
                  <span className="text-gray-300 flex items-center">
                    <FaGamepad className="mr-2 text-purple-400" /> Gaming Mini PCs
                  </span>
                </label>
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                  ...
                  />
                  <span className="text-gray-300 flex items-center">
                    <FaBriefcase className="mr-2 text-blue-400" /> Office Mini PCs
                  </span>
                </label>
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    ...
                    name="category"
                    value="Home Theater"
                    checked={category === "Home Theater"}
                    onChange={handleCategoryChange}
                    className="text-indigo-600 focus:ring-indigo-500"
                  />
                  <span className="text-gray-300 flex items-center">
                    <FaDesktop className="mr-2 text-green-400" /> Home Theater PCs
                  </span>
                </label>
              </div>
            </div>
          ...
          <div className="flex-1">
            {currentPCs.length > 0 ? (
                      ...
                      >
                        ...
                        <div className="relative h-48 bg-gray-900 p-4">
                          ...
                          <div className="absolute top-3 right-3 flex flex-col gap-1 z-10">
                            ...
                            <span className={`bg-gradient-to-r ${categoryInfo.color} text-white text-xs font-bold px-2 py-1 rounded shadow-lg flex items-center`}>
                              {categoryInfo.icon} {pc.category || 'Mini PC'}
                            </span>
                          </div>
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex flex-wrap gap-1 mb-2">
                            ...
                            {pc.specs?.hdmi && (
                              <span className="text-xs bg-blue-900/30 text-blue-400 px-2 py-0.5 rounded">HDMI</span>
                            )}
                          </div>
              ...
              >
                ...
                <h3 className="text-xl font-medium text-white mb-2">No Mini PCs found</h3>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <h3 className="font-bold text-lg">Gaming Mini PCs</h3>
              <p className="text-sm text-white/70 mt-2">Compact gaming powerhouses</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-bold text-lg">Office Mini PCs</h3>
              <p className="text-sm text-white/70 mt-2">Space-saving productivity</p>
            </motion.div>
            ...
            <motion.div
              ...
              onClick={() => setCategory("Home Theater")}
            >
              <FaDesktop className="text-4xl mx-auto mb-3" />
              <h3 className="font-bold text-lg">Home Theater PCs</h3>
              <p className="text-sm text-white/70 mt-2">Entertainment centers</p>
            </motion.div>
          </div>
        </motion.div>
